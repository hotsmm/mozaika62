<?php
	...
	if ($_POST['question'] == 'question1' ) {
		...
		if ( $_SESSION['answer1'] == 'Линейная' ) {
				...
				<div class="row align-items-center justify-content-center animated fadeIn" style="min-height: 275px;">
					<div class="col-md-6 pb-5">
						<div class="card bg-dark w-100 border-0">
							<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-2-1.jpg" class="card-img" alt="...">
			...
			echo '
				<div class="row align-items-center justify-content-center animated fadeIn" style="min-height: 275px;">
					<div class="col-md-6 pb-5">
						<div class="card bg-dark w-100 border-0">
							<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-2-2.jpg" class="card-img" alt="...">
							<div class="card-img-overlay">
								<input class="form-control d-inline" id="d1" style="height: 40px; max-width: 100px; position: absolute; top: -13px; right: 19%; text-align: center;" placeholder="??? м" required>
			...
			echo '
				<div class="row align-items-center justify-content-center animated fadeIn" style="min-height: 275px;">
					<div class="col-md-6 pb-5">
						<div class="card bg-dark w-100 border-0">
							<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-2-3.jpg" class="card-img" alt="...">
							<div class="card-img-overlay">
								<input class="form-control d-inline" id="d1" style="height: 40px; max-width: 100px; position: absolute; top: -13px; right: 19%; text-align: center;" placeholder="??? м" required>
								<input class="form-control d-inline" id="d2" style="height: 40px; max-width: 100px; position: absolute; top: 42%; left: -10%; text-align: center;" placeholder="??? м" required>
		...
		echo '	
			<div class="row pb-5 animated fadeIn">
				<div class="col text-center">
					<button class="btn btn-lg btn-primary2" onclick="question2();">Следующий вопрос</button>
				</div>
			</div>
		';
		...
		echo '
			...
			<div class="row justify-content-center text-center animated fadeIn pl-5 pr-5" style="min-height: 275px;">
				<div class="col-md-3 pb-5">
					<div class="card w-100 border-0">
						<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-3-1.jpg" class="m-auto w-75" alt="...">
				...
				<div class="col-md-3 pb-5">
					<div class="card w-100 border-0">
						<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-3-2.jpg" class="m-auto w-75" alt="...">
						<div class="card-body" style="min-height: auto;">
							<div class="custom-control custom-radio custom-control-inline">
				...
				<div class="col-md-3 pb-5">
					<div class="card w-100 border-0">
						<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-3-3.jpg" class="m-auto w-75" alt="...">
						<div class="card-body" style="min-height: auto;">
							<div class="custom-control custom-radio custom-control-inline">
				...
				<div class="col-md-3 pb-5">
					<div class="card w-100 border-0">
						<img src="https://мозаика62.рф/wp-content/themes/site100-furniture-child/images/quiz/q-3-4.jpg" class="m-auto w-75" alt="...">
						<div class="card-body" style="min-height: auto;">
							<div class="custom-control custom-radio custom-control-inline">
			...
			<div class="row pb-5 animated fadeIn">
				<div class="col text-center">
					<button class="btn btn-lg btn-primary2" onclick="question3();">Следующий вопрос</button>
				</div>
			</div>
		';
		...
		echo '
			<form method="post" action="https://мозаика62.рф/wp-content/themes/site100-furniture-child/mails/mail-quiz.php">
				<div class="row animated fadeIn">
					<div class="col pb-4 text-center">
				...
				<div class="row pb-5 animated fadeIn">
					<div class="col text-center">
						...
						<button type="submit" class="btn btn-lg btn-primary2">Получить рассчет</button>
					</div>
				</div>
			</form>
		';
